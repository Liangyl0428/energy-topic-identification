...
threadpool_limits(4)
while not (BASE / 'models/EMBEDDING_AUDIT.json').exists(): time.sleep(3)
...
while not (BASE / 'models/BOW_AUDIT.json').exists(): time.sleep(3)
