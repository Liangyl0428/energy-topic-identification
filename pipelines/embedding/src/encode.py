...
def main():
    require(BASE / 'data/INPUT_MANIFEST.json', BASE / 'models/multilingual_minilm/tokenizer.json', BASE / 'models/multilingual_minilm/onnx/model_O4_pooled.onnx', BASE / 'models/multilingual_minilm/onnx/model_O4.onnx')
